...
def word_splitter(text):
        ...
        text_copy = text + ' '
        while ' ' in text_copy:
                single_word = text_copy[:(text_copy.index(' '))]
                word_list.append(single_word)
                text_copy = text_copy[(text_copy.index(' ')+1):]
        return word_list
...
def nonveg_components():
        return ['Jagdwurstschnitzel','con','Bratwurstpfanne','Tintenfischringe','Hähnchenbruststreifen','Fleischfrikadelle','Hackfleischpfanne','Schweineleber','Hackfleischröllchen','Schollenfilet','Texasstyle','Seelachsfilet','Fisch','Hähnchenbruststeak','Wurstgulasch','Hähnchenkeule','Schwein','Steakhouse','Rostbrätel','Steak','Putengyros','Jagdwurst','Hühnerfrikassee','Schinken','Pfefferfleischwürfel','Puten-Leberragout','Hähnchenbrustfilet','Rindfleisch','Schweinekamm','Schweinefleisch','Shrimps','Bauernfrühstück','Hähnchenbrust','Hähnchenschnitzel','Brathering','Wurst','Käsehackbraten','Bratwurst','Schweinesteak','Heringsfilet','Chicken','Seelachs','Putenbruststreifen','Kassler','Rinderhacksteak','Rindermett','Putenschnitzel','Hackfleisch','Schweinegeschnetzeltes','Pute','Rostbraten','Putengeschnetzeltes','Rindersauerbraten','Tomaten-Schinkenragout','Ratsherrengeschnetzeltes','Thunfisch-Zucchinisauce','Rindfleischpfanne','Pfannengyros','Soljanka','Putensteak','Schweineschnitzel','Kassler-Sauerkraut','Geflügelsoße','Klopse','Mozzarellasticks','Rinderschmorbraten','Bolognesesoße','Chicken-Curry']
...
st.caption('Build 6, Stand: 7. September 2022')
