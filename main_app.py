...
with tab3:
        ...
        sel_df['meal'] = sel_df['meal'].str.lower().replace('strindberg','')
        ...
        if sel_df.shape[0] > 0:
                ...
                sel_df['Vegetarisch'] = sel_df['Vegetarisch'].astype(str)
                sel_df['Vegetarisch'] = ['Ja' if x == '1' else 'Nein' for x in sel_df['Vegetarisch']]
