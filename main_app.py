...
plot_width = 700*(1-mobile_version)+340*mobile_version
...
st.write((altair_bar+altair_line+altair_line_linreg).properties(width=plot_width,height=plot_height,actions=False))
