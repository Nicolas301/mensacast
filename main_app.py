...
if altair_test_plot:
        altair_bar = alt.Chart(plot_data).mark_bar().encode(x=alt.X('bar_labels',sort=None),y=alt.Y('avg_prices:Q',axis=alt.Axis(format='€')),color=alt.Color('arange_values',legend=None,scale=alt.Scale(scheme='redyellowgreen')))
