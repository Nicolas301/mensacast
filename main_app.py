...
bar_1 = go.Bar(x = plot_data['bar_labels'], y = plot_data['avg_prices'], name='', marker=dict(color=plot_data['arange_values'], colorscale = 'Darkmint'), showlegend = False)
line_1 = go.Scatter(mode = 'lines', x = plot_data['bar_labels'], y = plot_data['avg_prices'],line=dict(color="#FF8800"), name = 'Durchschnitt', showlegend = False)
