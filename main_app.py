...
bar_1 = go.Bar(x = plot_data['bar_labels'], y = plot_data['avg_prices'], name='Durchschnittspreis', marker=dict(color=plot_data['arange_values'], colorscale = 'RdBu'), showlegend = False)
