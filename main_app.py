...
if altair_test_plot:
        altair_bar = alt.Chart(plot_data).mark_bar(color=alt.Gradient(gradient='linear', stops=[alt.GradientStop(color='white', offset=0), alt.GradientStop(color='darkgreen', offset=1)])).encode(x=alt.X('bar_labels',sort=None),y='avg_prices:Q')
