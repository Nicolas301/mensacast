...
if altair_test_plot:
        altair_bar = alt.Chart(plot_data).mark_bar().encode(x='bar_labels',y='avg_prices:Q',order='arange_values')
        altair_line = alt.Chart(plot_data).mark_line().encode(x='bar_labels',y='avg_prices:Q',color=alt.value('orange'),order='arange_values')
        altair_line_linreg = alt.Chart(plot_data).mark_line().encode(x='bar_labels',y='lin_reg_values:Q',color=alt.value('red'),order='arange_values')
