...
if altair_test_plot:
        altair_bar = alt.Chart(plot_data).mark_bar().encode(x=alt.X('bar_labels',sort=None),y='avg_prices:Q',color=alt.Color('arange_values',legend=None,scale=alt.Scale(scheme='redyellowgreen')))
