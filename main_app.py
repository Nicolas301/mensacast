...
bar_1 = go.Bar(x = plot_data['bar_labels'], y = plot_data['avg_prices'], hoverinfo='Durchschnittspreis', marker=dict(color=plot_data['arange_values'], colorscale = 'RdBu'), showlegend = False)
line_2 = go.Scatter(mode = 'lines', x = plot_data['bar_labels'], y = plot_data['lin_reg_values'],line=dict(color="#FF0000"), hoverinfo = 'Linearer Trend', showlegend = False)
